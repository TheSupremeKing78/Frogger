	...
	public boolean testLose() {
		...
		if (this.environment.isSafe(position) == false){
			if (this.infini==false) {
				this.graphic.endGameScreen("You failed, try again ! Your time : " + (int)comp + "s" );
				return true;
			}
			else{
				this.graphic.endGameScreen("You failed, try again !  Score : " + this.score + ". Your time : "+ (int)comp + "s");
				return true;
